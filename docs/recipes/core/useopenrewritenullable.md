---
sidebar_label: "Prefer OpenRewrite Nullable"
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Prefer OpenRewrite Nullable

**com.gepardec.UseOpenRewriteNullable**

_Replaces JetBrains Nullable with OpenRewrite Nullable._
...
name: com.gepardec.UseOpenRewriteNullable
displayName: Prefer OpenRewrite Nullable
description: |
  Replaces JetBrains Nullable with OpenRewrite Nullable.
recipeList:
...
rewrite {
    activeRecipe("com.gepardec.UseOpenRewriteNullable")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.gepardec.UseOpenRewriteNullable</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=com.gepardec:write-open-rewrite:RELEASE -Drewrite.activeRecipes=com.gepardec.UseOpenRewriteNullable -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe UseOpenRewriteNullable
```
