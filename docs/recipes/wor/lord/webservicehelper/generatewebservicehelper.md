...
**com.gepardec.wor.lord.webservicehelper.GenerateWebserviceHelper**
...
rewrite {
    activeRecipe("com.gepardec.wor.lord.webservicehelper.GenerateWebserviceHelper")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.gepardec.wor.lord.webservicehelper.GenerateWebserviceHelper</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=com.gepardec:write-open-rewrite:RELEASE -Drewrite.activeRecipes=com.gepardec.wor.lord.webservicehelper.GenerateWebserviceHelper -Drewrite.exportDatatables=true
```
</TabItem>
...
```shell title="shell"
mod run . --recipe GenerateWebserviceHelper
```
