...
**com.gepardec.wor.lord.servicehelper.GenerateWebserviceHelper**
...
rewrite {
    activeRecipe("com.gepardec.wor.lord.servicehelper.GenerateWebserviceHelper")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.gepardec.wor.lord.servicehelper.GenerateWebserviceHelper</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=com.gepardec:write-open-rewrite:RELEASE -Drewrite.activeRecipes=com.gepardec.wor.lord.servicehelper.GenerateWebserviceHelper -Drewrite.exportDatatables=true
```
</TabItem>
