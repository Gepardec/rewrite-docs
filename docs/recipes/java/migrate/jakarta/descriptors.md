---
sidebar_label: "Migrate JEE Descriptors to Jakarta EE 10"
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Migrate JEE Descriptors to Jakarta EE 10

**com.gepardec.java.migrate.jakarta.Descriptors**

_These recipes help with the Migration to Jakarta EE 10._
...
description: |
  These recipes help with the Migration to Jakarta EE 10.
tags:
  - jakarta
recipeList:
...
rewrite {
    activeRecipe("com.gepardec.java.migrate.jakarta.Descriptors")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.gepardec.java.migrate.jakarta.Descriptors</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=com.gepardec:write-open-rewrite:RELEASE -Drewrite.activeRecipes=com.gepardec.java.migrate.jakarta.Descriptors -Drewrite.exportDatatables=true
```
</TabItem>
